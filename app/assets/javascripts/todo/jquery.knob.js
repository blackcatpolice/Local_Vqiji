...
$(function () {
    ...
    var Dial = function (c, opt) {
        ...
        this.draw = function (nv) {
            /* 
              FIXED：当使用 excanvas 绘图时，
              如果 nv == 0，则绘制出来的图形和 100 一样
             */
            nv = (nv != 0) ? nv : 0.001;
        ...
        return this.each(
            ...
            function () {
                ...
                opt = $.extend(
                    {
                       ...
                       ,'readOnly' : true
                        ...
                        ,'fgColor' : $this.data('fgcolor') || '#40b5ff'
                        ,'cgColor' : $this.data('cgcolor') || $this.data('fgcolor') || '#ff0000'
                ...
                if (window.G_vmlCanvasManager) {
                  G_vmlCanvasManager.initElement(c[0]);
                }
