...
module Weibo
  class Application < Rails::Application
    ...
    config.autoload_paths += [
      "#{Rails.root}/app/lib", "#{Rails.root}/app/jobs",
    ...
    config.mongoid.observers = [
      #'notification/observers/tweet_observer', 
      'notification/observers/comment_observer',
      'notification/observers/mention_observer', 'notification/observers/followship_observer',
